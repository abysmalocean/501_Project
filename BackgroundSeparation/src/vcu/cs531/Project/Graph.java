	...
	public int FordFulkerson()
	{
		...
		while(true)
		{
			...
			if(MinCapacity > TempCapacity)
			{
				...
				MinCapacityVertexV0 = this.path.get(0); 
				MinCapacityVertexV1 = -2;
			}
			...
			vertex0 = ProjectHelper.VertexSearch_ById(this.path.get(MinCapacityVertexV0), this.Patamater, this.VertexRoster);
			vertex1 = ProjectHelper.VertexSearch_ById(this.path.get(MinCapacityVertexV0), this.Patamater, this.VertexRoster);
			for(adjacentlsit templist:vertex0.addjlist)
			{
